...
const { compareTime, shortDate, longDate, parseDate, parseTime, parseDateTime } = require('@datatype/type-datetime.js');

describe('Datetime helpers', function () {
    describe('#compareTime(t1, t2)', function () {
        it("should return 1 if the second time is greater than the first", function () {
            var values = [
                { t1: "13:30", t2: "14:00" },
                { t1: "13:30", t2: "13:50" },
