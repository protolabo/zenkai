...
const { 
    valOrDefault, isEmpty, isDate, isString, isFunction, isObject, 
    isIterable, isNull, isNullOrWhitespace, isUndefined, isNullOrUndefined 
} = require('@datatype/type-parse.js');
